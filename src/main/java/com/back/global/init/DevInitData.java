...
public class DevInitData {
    ...
    public void fakeNewsInit() {
        ...
        FakeNewsDto fakeNews1 = FakeNewsDto.of(
                1L,
                "정부, 소비쿠폰 지급 예산 3배 증액 발표...국민 1인당 30만원 지급 예정",
                "정부가 민생회복 소비쿠폰 지급 예산을 기존의 3배로 증액하여 국민 1인당 30만원을 지급하기로 결정했다고 발표했다. 이는 기존 지급액의 대폭 확대로, 내수 경기 활성화를 위한 강력한 부양책이라고 정부는 설명했다."
                // 첫 번째 실제 뉴스와 연결
        );
        ...
        FakeNewsDto fakeNews2 = FakeNewsDto.of(
                2L,
                "여름 제철 감자·옥수수 가격 50% 폭락...농가 비상사태 선포",
                "올해 여름 제철 간식으로 인기인 감자와 찰옥수수의 가격이 전년 대비 50% 폭락하면서 농가들이 비상사태를 선포했다. 전국농민연합회는 긴급 대책회의를 소집하고 정부 지원을 요청할 예정이라고 밝혔다."
        );

        // 페이크뉴스 3
        FakeNewsDto fakeNews3 = FakeNewsDto.of(
                3L,
                "하이원리조트 워터월드서 대형 사고 발생...50명 부상",
                "강원도 하이원리조트 워터월드에서 DJ 풀 파티 진행 중 대형 안전사고가 발생해 50여 명이 부상을 입었다고 소방당국이 발표했다. 인공파도 시설 오작동이 사고 원인으로 추정되며, 현재 시설 운영이 전면 중단된 상태다."
        );

        // 페이크뉴스 4
        FakeNewsDto fakeNews4 = FakeNewsDto.of(
                4L,
                "신용카드 이용금액 급증의 진짜 이유는 '디지털 화폐' 실험",
                "최근 신용카드 이용금액이 급증한 것은 정부의 비밀 디지털 화폐 실험 때문이라는 충격적인 사실이 밝혀졌다. 익명의 정부 관계자는 국민들이 모르는 사이에 결제 시스템을 통해 디지털 화폐 유통을 테스트하고 있다고 폭로했다."
        );
        ...
        FakeNewsDto fakeNews5 = FakeNewsDto.of(
                5L,
                "하이원리조트, 실제로는 외국 자본이 운영...강원랜드는 허위 발표",
                "하이원리조트가 강원랜드 소유가 아닌 외국 자본이 실제 운영하고 있다는 충격적인 사실이 드러났다. 내부 고발자에 따르면 지난 3년간 중국 자본이 리조트 운영권을 장악하고 있었으며, 강원랜드는 이를 숨기기 위해 허위 발표를 해왔다고 주장했다."
        );

        // 페이크뉴스 7
        FakeNewsDto fakeNews6 = FakeNewsDto.of(
                6L,
                "소비자심리지수 조작 의혹...통계청 내부자 폭로",
                "통계청이 발표한 소비자심리지수가 조작되었다는 의혹이 제기됐다. 통계청 내부자는 '정부의 압력으로 지수를 의도적으로 높게 발표하도록 지시받았다'며 실제 지수는 발표치보다 20포인트 낮다고 폭로했다."
        );

        // 페이크뉴스 8
        FakeNewsDto fakeNews7 = FakeNewsDto.of(
                7L,
                "전국 하나로마트서 식중독균 검출...농협 은폐 시도 논란",
                "전국 농협 하나로마트에서 판매되는 신선식품에서 치명적인 식중독균이 대량 검출됐음에도 농협이 이를 은폐하려 했다는 논란이 일고 있다. 보건당국은 긴급 조사에 착수했으며, 농협은 해명에 나서고 있다."
        );
